...
class CreateOrdersController(QObject):
    ...
    def connect_signals(self):
        self.ui.btn_open.clicked.connect(self.open_filecreation) # button to open file dialog
        self.ui.btn_login_create.clicked.connect(lambda: self.login_sap("user_create", "pass_create", self.ui.btn_login_create)) # button for conection to SAP
        self.ui.btn_creation.clicked.connect(self.creation_clicked) # button for creation of documents
    ...
    def open_filecreation(self):
        ...
        self.ui.txt_filecreation.setText(file_path_creation)
    ...
    def load_excel_creation(self, file_path_creation: str, sheet_name: str='Creation'):
        ...
        tbl = self.ui.tb_creation # o self.ui.tableWidget
